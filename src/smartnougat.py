...
class SmartNougatStandalone:
    ...
    def _recognize_formula_with_nougat(self, formula_img: np.ndarray) -> str:
        ...
        try:
            ...
            # Nougat 처리
            processor = self.nougat_model['processor']
        ...
        if model_json_path.exists():
            try:
                ...
                fix_result = subprocess.run(
                    [sys.executable, "src/fix_latex.py", str(model_json_path)],
                    capture_output=True,
                    text=True
                )
                ...
                if fix_result.returncode == 0:
                    ...
                    if model_fixed_path.exists():
                        ...
                        viewer_cmd = [sys.executable, "src/create_viewer.py", str(result['output_dir'])]
